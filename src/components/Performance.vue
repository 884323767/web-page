    ...
    <div class="performance">
      <div class="menu-group">
        ...
        <div class="menu-container">
          <p :class="{'active': active}" @click="changeSelect">Values Performance</p>
          <p :class="{'active': !active}" @click="changeSelect">Returns Performance</p>
        </div>
        </div>
...
export default {
    components: {
        selection, pieChart,lineChart,calendar
    },
    route: {
        data(transition) {
